...
struct BottomFloatingBarView: View {
    @ObservedObject var viewModel: WallpaperViewModel
    @State private var searchText = ""; @State private var isHotSelected = false; @State private var jumpPageText = ""
